...
def _analyze_youtube(url: str) -> VideoContextReport:
    ...
    return VideoContextReport(
        platform="YouTube",
        capabilityLevel="youtube_data_api_v3",
        videoId=video_id,
        ...
        descriptionLinkSummary=summary["descriptionLinkSummary"],
        playlistContextSummary=summary["playlistContextSummary"],
        channelHistorySummary=summary["channelHistorySummary"],
        freshnessSummary=summary["freshnessSummary"],
        contentIntent=summary["contentIntent"],
        claimRiskScore=summary["claimRiskScore"],
        contextRiskScore=summary["contextRiskScore"],
        contextRiskSummary=summary["contextRiskSummary"],
        ...
        sourceMethods=["youtube_data_api_v3"],
        comments=comments,
    )
